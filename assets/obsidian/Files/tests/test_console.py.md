- File containing all custom unittests that we created to test all the features.
- We divided the test in groups, to make the file more understable, each group is explained within "-group function-"
